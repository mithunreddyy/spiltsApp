...
const metadata = {
    ...
    description: "Track shared expenses and splits among friends with an elegant glass morphism interface",
    keywords: [
        "expense tracker",
        "split bills",
        "money management",
    ...
    authors: [
        {
            name: "Money Splits Team"
        }
    ],
    openGraph: {
        title: "Money Splits - Beautiful Expense Tracking",
        description: "Track shared expenses with friends using our stunning glass morphism interface",
        type: "website"
    }
};
